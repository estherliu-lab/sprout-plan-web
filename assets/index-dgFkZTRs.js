...
`),l=ie(c),u=ne(c,`时长`)||l.duration||`10分钟`,d=ne(c,`材料`)||l.materials||`不需要`,f=ne(c,`玩法`)||ae(c),p=[ne(c,`趣味变化`),re(c,[`升级`,`升级玩法`])].filter(Boolean).join(`；`)||`孩子熟悉后，可以交换角色或加入自己的新规则。`,m=u.match(/\d+/g)?.map(Number)||[10],h=Math.max(...m),g=re(c,[`目标`,`英语目标`]),_=C(a,n,o,g),v=g||oe(_),y=/户外|公园|超市|散步|自然|风|云|影子|雨量/.test(`${o}${f}`),b=ue(o,d,c),S=`${o}${v}${f}${d}`,te=/指一指|拍一拍|摸一摸|闻一闻|听一听|找颜色|认颜色|配对|模仿|传球|撕纸|贴纸|吹泡泡|躲猫猫|身体部位/.test(S),de=/故事接龙|采访|小记者|编故事|复述|排序|序列|规律|测量|统计|地图|迷宫|预测|实验|拼读|押韵|造句|分类理由|角色对话|规则设计/.test(S),w=/拼读|统计|地图|采访|故事接龙|完整复述|设计规则|记录实验|比较结果/.test(S),T=te?2:w?5:de?4:3;h>=20&&T<4&&(T=4),/剪刀|热水|加热|刀具|烤箱|炉灶/.test(S)&&T<4&&(T=4);let fe=T===2&&te?4:T===2?5:6,pe=T<=2?`轻松`:T===3?`适中`:`进阶`,me=/剪刀|热水|加热|刀具|烤箱|炉灶|户外|过马路|蒙眼/.test(S)?`一起完成`:`少量协助`;r.push({id:`activity-${i[1]}`,number:a,title:o,summary:v||f.slice(0,28),goal:v,series:le(a,_,n),category:_,duration:h,durationLabel:u,location:y?`都可以`:`室内`,prep:d===`不需要`?`不用准备`:`简单准备`,minAge:T,maxAge:fe,difficulty:pe,adultSupport:me,materials:d===`不需要`?[]:d.split(/[、，]/).map(e=>e.trim()).filter(Boolean),steps:se(f),opening:`今天我们来试试「${o}」，你想从哪里开始？`,questions:[`在「${o}」里，你发现了什么？`,`如果再玩一次，你想换一种什么办法？`],easy:`先只做第一小步：${se(f)[0]?.replace(/[。！？]$/,``)||`自由探索材料`}。孩子愿意时再继续，不要求完成。`,upgrade:p,safety:b||void 0,color:x[(a-1)%x.length],emoji:ce(`${o}${v}`),accentEmoji:ee[a*7%ee.length],visualIndex:a,englishGuide:_===`英语启蒙`?he(c,v,o):void 0})}return r}var D=E(`${y}\n${b}`),ge=[`全部`,`英语启蒙`,`语言表达`,`数量逻辑`,`空间认知`,`精细动作`,`大运动`,`生活能力`,`情绪社交`,`自然科学`,`艺术创造`,`音乐节奏`],_e=[`早餐后`,`上午`,`午睡后`,`傍晚`,`睡前`],ve=(e,t)=>t>=e.minAge&&t<=e.maxAge,ye=[`语言表达`,`数量逻辑`,`空间认知`,`精细动作`,`大运动`,`生活能力`,`情绪社交`,`自然科学`,`艺术创造`,`音乐节奏`,`英语启蒙`],be=ye.map(e=>D.filter(t=>t.category===e)),xe=e=>D[e%D.length],Se=(e,t,n,r)=>{let i=xe(r);return{uid:`seed-${e}-${t}`,kind:`activity`,slot:n,activityId:i.id,title:i.title,duration:i.duration}},Ce=(e,t,n,r,i,a)=>({uid:`rhythm-${e}-${t}`,kind:r,slot:n,title:i,duration:a});function we(e=0,t=3){let n=ye.map(e=>D.filter(n=>n.category===e&&ve(n,t))),r=(e,t)=>{let r=n[e%n.length],i=be[e%be.length],a=r.length?r:i;return a[t%a.length]};return Array.from({length:7},(t,n)=>{let i=n*2%be.length,a=(n*2+3)%be.length,o=(n*2+7)%be.length,s=r(i,e+n),c=r(a,e+n*2),l=r(o,e+n*3);return[{...Se(n,0,`上午`,0),activityId:s.id,title:s.title,duration:s.duration},Ce(n,1,`上午`,`rest`,`喝水 · 看窗外`,10),{...Se(n,2,`上午`,0),activityId:c.id,title:c.title,duration:c.duration},Ce(n,3,`午睡后`,n%2?`chore`:`free`,n%2?`一起收玩具`:`自由玩耍`,15),{...Se(n,4,`傍晚`,0),activityId:l.id,title:l.title,duration:l.duration},Ce(n,5,`睡前`,`rest`,`安静拥抱与休息`,10)]})}var Te=[{kind:`rest`,title:`喝水 · 看窗外`,duration:10,emoji:`☁️`},{kind:`rest`,title:`安静拥抱与休息`,duration:10,emoji:`🤍`},{kind:`free`,title:`孩子自由玩耍`,duration:20,emoji:`🧸`},{kind:`chore`,title:`一起收玩具`,duration:15,emoji:`🧺`},{kind:`chore`,title:`帮忙摆餐具`,duration:10,emoji:`🥄`},{kind:`meal`,title:`水果与点心时间`,duration:20,emoji:`🍎`},{kind:`nap`,title:`午睡与安静时间`,duration:60,emoji:`🌙`}],Ee=new Set([`page`,`age`,`activity_id`,`category`,`age_band`,`source`,`saved`,`item_kind`,`slot`,`routine_id`,`step_index`,`completed`,`print_type`,`water_level`,`result_count`,`app_version`]),De=`phc_v8XbAC2vg4SzTTmjDYGyJJxZyR6uYchFEeNDDrWV3DgE`,Oe=`https://us.i.posthog.com/i/v0/e/`,ke=!1;function Ae(){let e=`sprout-plan-anonymous-id`,t=localStorage.getItem(e);if(t)return t;let n=typeof crypto.randomUUID==`function`?crypto.randomUUID():`sprout-${Date.now()}-${Math.random().toString(36).slice(2)}`;return localStorage.setItem(e,n),n}function je(){ke||typeof window>`u`||(ke=!0,O(`app_opened`))}function O(e,t={}){if(!ke||typeof window>`u`)return;let n=Object.fromEntries(Object.entries({...t,app_version:`0.1.0`}).filter(([e,t])=>Ee.has(e)&&t!==void 0).map(([e,t])=>[e,typeof t==`string`?t.slice(0,64):t]));if([`localhost`,`127.0.0.1`].includes(window.location.hostname))return;let r=Oe,i={api_key:De,event:e,distinct_id:Ae(),properties:{...n,$process_person_profile:!1,$geoip_disable:!0}};fetch(r,{method:`POST`,headers:{"Content-Type":`application/json`},credentials:`omit`,keepalive:!0,body:JSON.stringify(i)}).catch(()=>void 0)}function Me(e,t){return{activity_id:e.id,category:e.category,age_band:`${e.minAge}-${e.maxAge}`,source:t}}var Ne=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),k=o(((e,t)=>{t.exports=Ne()}))(),A=e=>`/sprout-plan-web/${e.replace(/^\/+/,``)}`,Pe=[`周一`,`周二`,`周三`,`周四`,`周五`,`周六`,`周日`],Fe=Object.fromEntries(new Intl.DateTimeFormat(`zh-CN`,{timeZone:`Asia/Shanghai`,year:`numeric`,month:`numeric`,day:`numeric`,weekday:`long`}).formatToParts(new Date).map(e=>[e.type,e.value])),Ie=`${Fe.year}-${String(Fe.month).padStart(2,`0`)}-${String(Fe.day).padStart(2,`0`)}`,Le=Fe.weekday.replace(`星期`,`周`),Re=`${Fe.month}月${Fe.day}日 · ${Le}`,ze=[{key:`today`,label:`今天`,icon:`home`},{key:`plan`,label:`计划`,icon:`calendar`},{key:`activities`,label:`活动`,icon:`leaf`},{key:`records`,label:`成长`,icon:`book`},{key:`profile`,label:`设置`,icon:`person`}],Be=[{value:`状态不错`,icon:`smile`,hint:`照常玩`},{value:`有点忙碌`,icon:`clock`,hint:`少一点`},{value:`有点累`,icon:`moon`,hint:`轻松玩`},{value:`需要放松`,icon:`cloud`,hint:`安静陪伴`}],Ve=e=>{let t=[`语言表达`,`精细动作`,`自然科学`].map(t=>D.find(n=>n.category===t&&ve(n,e))).filter(e=>!!e),n=D.filter(n=>ve(n,e)&&!t.some(e=>e.id===n.id));return[...t,...n].slice(0,3).map(e=>e.id)},He={version:7,onboarding:!1,nickname:`小树`,age:3,mood:`状态不错`,todayIds:Ve(3),plan:we(0,3),favorites:[],completions:[],avatarKind:`preset`,avatarPreset:1,avatarData:``,dailyMinutes:30,activityTimes:[`上午`,`午睡后`],reminders:!0,interests:[`语言表达`,`生活能力`,`自然观察`],routineDate:Ie,routineChecks:{},ritualDate:Ie,ritualWater:0};function Ue(){try{let e=JSON.parse(localStorage.getItem(`sprout-plan-state`)||`{}`),t=new Set(D.map(e=>e.id)),n=Math.min(6,Math.max(2,Number(e.age)||3)),r=(e.version||0)<7,i=!r&&Array.isArray(e.plan)&&e.plan.length===7&&e.plan.every(e=>Array.isArray(e)&&e.every(e=>typeof e==`object`&&e&&`slot`in e))?e.plan:we(0,n),a=Array.isArray(e.todayIds)?e.todayIds.filter(e=>t.has(e)):[],o=e.routineDate===Ie&&e.routineChecks?e.routineChecks:{},s=e.ritualDate===Ie?Math.min(5,Math.max(0,Number(e.ritualWater)||0)):0;return{...He,...e,version:He.version,age:n,todayIds:!r&&a.length?a:Ve(n),plan:i,favorites:(e.favorites||[]).filter(e=>t.has(e)),completions:(e.completions||[]).filter(e=>t.has(e.activityId)),routineDate:Ie,routineChecks:o,ritualDate:Ie,ritualWater:s}}catch{return He}}function j({name:e,size:t=22}){let n={home:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`path`,{d:`M3 11.5 12 4l9 7.5`}),(0,k.jsx)(`path`,{d:`M5.5 10v10h13V10M9 20v-6h6v6`})]}),calendar:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`rect`,{x:`3`,y:`5`,width:`18`,height:`16`,rx:`3`}),(0,k.jsx)(`path`,{d:`M8 3v4m8-4v4M3 10h18m-13 4 2 2 5-5`})]}),leaf:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`path`,{d:`M19 4C10 4 5 9 5 16c5 1 11-2 14-12Z`}),(0,k.jsx)(`path`,{d:`M4 21c2-6 6-9 11-12`})]}),book:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`path`,{d:`M4 5.5A4 4 0 0 1 8 4h3v16H8a4 4 0 0 0-4 1.5Z`}),(0,k.jsx)(`path`,{d:`M20 5.5A4 4 0 0 0 16 4h-3v16h3a4 4 0 0 1 4 1.5Z`})]}),person:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`circle`,{cx:`12`,cy:`7.5`,r:`3.5`}),(0,k.jsx)(`path`,{d:`M5 21a7 7 0 0 1 14 0`})]}),bell:(0,k.jsx)(k.Fragment,{children:(0,k.jsx)(`path`,{d:`M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9Zm-8 12h4`})}),heart:(0,k.jsx)(`path`,{d:`M20.8 5.7c-1.7-2-4.8-2.1-6.7-.2L12 7.6 9.9 5.5C8 3.6 4.9 3.7 3.2 5.7c-1.5 1.8-1.3 4.5.4 6.1L12 20l8.4-8.2c1.7-1.6 1.9-4.3.4-6.1Z`}),search:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`circle`,{cx:`11`,cy:`11`,r:`7`}),(0,k.jsx)(`path`,{d:`m20 20-4-4`})]}),arrow:(0,k.jsx)(`path`,{d:`m9 18 6-6-6-6`}),back:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`path`,{d:`m15 18-6-6 6-6`}),(0,k.jsx)(`path`,{d:`M9 12h11`})]}),check:(0,k.jsx)(`path`,{d:`m5 12 4 4L19 6`}),close:(0,k.jsx)(k.Fragment,{children:(0,k.jsx)(`path`,{d:`m6 6 12 12M18 6 6 18`})}),swap:(0,k.jsx)(k.Fragment,{children:(0,k.jsx)(`path`,{d:`M7 7h11l-3-3m3 13H7l3 3`})}),plus:(0,k.jsx)(k.Fragment,{children:(0,k.jsx)(`path`,{d:`M12 5v14M5 12h14`})}),smile:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`circle`,{cx:`12`,cy:`12`,r:`9`}),(0,k.jsx)(`path`,{d:`M8 10h.01M16 10h.01M8 14c2.5 3 5.5 3 8 0`})]}),clock:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`circle`,{cx:`12`,cy:`12`,r:`9`}),(0,k.jsx)(`path`,{d:`M12 7v5l3 2`})]}),moon:(0,k.jsx)(`path`,{d:`M20 15.2A8 8 0 0 1 8.8 4 8 8 0 1 0 20 15.2Z`}),cloud:(0,k.jsx)(`path`,{d:`M7 18h11a4 4 0 0 0 .7-7.9A6 6 0 0 0 7.4 8.3 4.8 4.8 0 0 0 7 18Z`}),download:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`path`,{d:`M12 3v12m-4-4 4 4 4-4`}),(0,k.jsx)(`path`,{d:`M5 20h14`})]}),upload:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`path`,{d:`M12 16V4m-4 4 4-4 4 4`}),(0,k.jsx)(`path`,{d:`M5 20h14`})]}),volume:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`path`,{d:`M5 10v4h4l5 4V6l-5 4Z`}),(0,k.jsx)(`path`,{d:`M17 9a4 4 0 0 1 0 6m2-9a8 8 0 0 1 0 12`})]}),printer:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`path`,{d:`M7 9V3h10v6M7 17H4V9h16v8h-3`}),(0,k.jsx)(`path`,{d:`M7 14h10v7H7Z`}),(0,k.jsx)(`path`,{d:`M17 11h.01`})]}),camera:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`path`,{d:`M4 8h3l1.5-2h7L17 8h3v11H4Z`}),(0,k.jsx)(`circle`,{cx:`12`,cy:`13`,r:`3.2`})]}),settings:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`circle`,{cx:`12`,cy:`12`,r:`3`}),(0,k.jsx)(`path`,{d:`M19 12a7 7 0 0 0-.1-1l2-1.5-2-3.4-2.4 1A8 8 0 0 0 15 6l-.3-2.6h-4L10.4 6A8 8 0 0 0 9 7.1l-2.4-1-2 3.4L6.7 11a7 7 0 0 0 0 2L4.6 14.5l2 3.4 2.4-1A8 8 0 0 0 10.4 18l.3 2.6h4L15 18a8 8 0 0 0 1.5-1.1l2.4 1 2-3.4-2-1.5a7 7 0 0 0 .1-1Z`})]}),shield:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`path`,{d:`M12 3 5 6v5c0 4.7 2.7 8 7 10 4.3-2 7-5.3 7-10V6Z`}),(0,k.jsx)(`path`,{d:`m9 12 2 2 4-5`})]}),sparkle:(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`path`,{d:`m12 3 1.2 4.3L17 9l-3.8 1.7L12 15l-1.2-4.3L7 9l3.8-1.7Z`}),(0,k.jsx)(`path`,{d:`m19 15 .6 2.2L22 18l-2.4.8L19 21l-.6-2.2L16 18l2.4-.8Z`})]})};return(0,k.jsx)(`svg`,{"aria-hidden":`true`,viewBox:`0 0 24 24`,width:t,height:t,fill:`none`,stroke:`currentColor`,strokeWidth:`1.8`,strokeLinecap:`round`,strokeLinejoin:`round`,children:n[e]||n.leaf})}function We(){return(0,k.jsxs)(`div`,{className:`logo`,children:[(0,k.jsxs)(`span`,{className:`logo-mark`,children:[(0,k.jsx)(`i`,{}),(0,k.jsx)(`i`,{}),(0,k.jsx)(`b`,{})]}),(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`strong`,{children:`小芽计划`}),(0,k.jsx)(`small`,{children:`Sprout Plan`})]})]})}function Ge({data:e,size:t=48}){return e.avatarKind===`upload`&&e.avatarData?(0,k.jsx)(`span`,{className:`child-avatar uploaded`,style:{width:t,height:t},children:(0,k.jsx)(`img`,{src:e.avatarData,alt:`孩子头像`})}):(0,k.jsx)(`span`,{className:`child-avatar preset avatar-${e.avatarPreset}`,style:{width:t,height:t},role:`img`,"aria-label":`孩子的可爱头像`})}function Ke(){let[e,t]=(0,_.useState)(Ue),[n,r]=(0,_.useState)(`today`),[i,a]=(0,_.useState)(null),[o,s]=(0,_.useState)(null),[c,l]=(0,_.useState)(!1),[u,d]=(0,_.useState)(``),f=(0,_.useRef)(null);(0,_.useEffect)(()=>{localStorage.setItem(`sprout-plan-state`,JSON.stringify(e))},[e]),(0,_.useEffect)(()=>{O(`page_viewed`,{page:n===`activities`&&c?`favorites`:n})},[n,c]);let p=e=>{d(e),window.setTimeout(()=>d(``),2200)},m=e=>t(t=>({...t,...e})),h=e=>{e===`activities`&&l(!1),a(null),s(null),r(e),f.current?.scrollTo({top:0,behavior:`auto`}),window.scrollTo({top:0,behavior:`auto`})},g=()=>{l(!0),a(null),s(null),r(`activities`),f.current?.scrollTo({top:0,behavior:`auto`}),window.scrollTo({top:0,behavior:`auto`})},v=n!==`today`||!!i||!!o,y=i||o?`返回活动列表`:n===`activities`&&c?`返回设置`:`返回今天`,b=()=>{if(o){s(null);return}if(i){a(null);return}if(n===`activities`&&c){h(`profile`);return}h(`today`)},x=e.todayIds.map(e=>D.find(t=>t.id===e)).filter(Boolean),ee=e.completions.filter(e=>e.date===Ie).length,S=(e,t=`activity_library`)=>{O(`activity_opened`,Me(e,t)),a(e)},C=(e,t=`activity_detail`)=>{O(`activity_started`,Me(e,t)),s(e)},te=t=>{let n=!e.favorites.includes(t.id);m({favorites:n?[...e.favorites,t.id]:e.favorites.filter(e=>e!==t.id)}),O(`activity_saved`,{...Me(t,`activity_detail`),saved:n})};return(0,k.jsxs)(`div`,{className:`app-bg`,children:[!e.onboarding&&(0,k.jsx)(qe,{onDone:(e,t)=>{m({onboarding:!0,nickname:e,age:t,todayIds:Ve(t),plan:we(0,t)}),O(`onboarding_completed`,{age:t})}}),(0,k.jsxs)(`aside`,{className:`desktop-rail`,children:[(0,k.jsx)(We,{}),(0,k.jsx)(`p`,{children:`把每天的陪伴，轻松安排成一份有趣的成长计划。`}),(0,k.jsxs)(`div`,{className:`rail-note`,children:[(0,k.jsx)(`span`,{children:`今天不需要很满`}),(0,k.jsxs)(`strong`,{children:[`留一点空白，`,(0,k.jsx)(`br`,{}),`也留一点惊喜。`]})]}),(0,k.jsx)(`div`,{className:`rail-art`,children:(0,k.jsx)(`img`,{src:A(`assets/mascot.webp`),alt:`芽芽小助手`})}),(0,k.jsx)(`small`,{children:`资料只保存在这台设备上`})]}),(0,k.jsxs)(`main`,{className:`app-shell`,children:[(0,k.jsxs)(`header`,{className:`topbar`,children:[(0,k.jsxs)(`div`,{className:`topbar-left`,children:[v&&(0,k.jsxs)(`button`,{className:`top-back`,"aria-label":y,onClick:b,children:[(0,k.jsx)(j,{name:`back`,size:20}),(0,k.jsx)(`span`,{children:`返回`})]}),(0,k.jsx)(We,{})]}),(0,k.jsx)(`div`,{className:`top-actions`,children:(0,k.jsx)(`button`,{className:`avatar-shortcut`,"aria-label":`打开孩子设置`,onClick:()=>h(`profile`),children:(0,k.jsx)(Ge,{data:e,size:34})})})]}),(0,k.jsxs)(`div`,{className:`page-wrap`,ref:f,children:[n===`today`&&(0,k.jsx)(Ye,{data:e,mood:e.mood,onMood:e=>m({mood:e}),activities:x,completed:ee,completions:e.completions,onOpen:e=>S(e,`today_basket`),onReplace:t=>{let n=D.find(e=>e.id===t),r=D.filter(t=>ve(t,e.age)&&!e.todayIds.includes(t.id)),i=r.find(e=>e.category===n.category)||r[Math.floor(Math.random()*r.length)]||n;m({todayIds:e.todayIds.map(e=>e===t?i.id:e)}),p(`换成了「${i.title}」`)},onRecord:e=>C(e,`today_basket`),onNavigate:h,ritualWater:e.ritualWater,onRitual:()=>{let t=Math.min(5,e.ritualWater+1);m({ritualWater:t,ritualDate:Ie}),O(`ritual_watered`,{water_level:t}),p(t===5?`今天的小芽喝饱水啦`:`浇了一点水，小芽的水位升高了`)}}),n===`plan`&&(0,k.jsx)(et,{plan:e.plan,onPlan:e=>m({plan:e}),onOpen:e=>S(e,`weekly_plan`),notify:p,nickname:e.nickname,childAge:e.age,todayActivities:x,routineChecks:e.routineChecks,onRoutineChecks:e=>m({routineChecks:e,routineDate:Ie})}),n===`activities`&&(0,k.jsx)(it,{favorites:e.favorites,savedOnly:c,childAge:e.age,onSavedOnly:l,onFavorites:e=>m({favorites:e}),onOpen:e=>S(e,c?`favorites`:`activity_library`),onAdd:t=>{e.todayIds.includes(t.id)||m({todayIds:[...e.todayIds,t.id]}),O(`plan_item_added`,{...Me(t,`activity_library`),item_kind:`activity`,slot:`today`}),p(`已经放进今天的成长篮子`)}}),n===`records`&&(0,k.jsx)(at,{completions:e.completions,onExplore:()=>h(`activities`)}),n===`profile`&&(0,k.jsx)(ot,{data:e,onData:t,onOpenFavorites:g,notify:p})]}),(0,k.jsx)(`nav`,{className:`bottom-nav`,"aria-label":`主要页面`,children:ze.map(e=>(0,k.jsxs)(`button`,{className:(n===`activities`&&c?`profile`:n)===e.key?`active`:``,onClick:()=>h(e.key),children:[(0,k.jsx)(`span`,{className:`nav-icon`,children:(0,k.jsx)(j,{name:e.icon})}),(0,k.jsx)(`span`,{children:e.label})]},e.key))})]}),i&&(0,k.jsx)(lt,{activity:i,favorite:e.favorites.includes(i.id),onFavorite:()=>te(i),onClose:()=>a(null),onRecord:()=>C(i)}),o&&(0,k.jsx)(ut,{activity:o,onClose:()=>s(null),onSave:(t,n,r)=>{let i=e.completions.filter(e=>!(e.activityId===t.id&&e.date===Ie));m({completions:[...i,{activityId:t.id,date:Ie,reaction:n,quote:r.trim()||void 0}]}),s(null),a(null),p(`记下来了，小芽又长大一点点`),O(`activity_completed`,Me(t,`completion_sheet`))}}),u&&(0,k.jsxs)(`div`,{className:`toast`,children:[(0,k.jsx)(j,{name:`check`,size:18}),u]})]})}function qe({onDone:e}){let[t,n]=(0,_.useState)(0),[r,i]=(0,_.useState)(`小树`),[a,o]=(0,_.useState)(3),[s,c]=(0,_.useState)([`绘本`,`植物`,`户外散步`]);return(0,k.jsx)(`div`,{className:`onboarding`,children:(0,k.jsxs)(`div`,{className:`onboard-card`,children:[(0,k.jsxs)(`div`,{className:`onboard-art`,children:[(0,k.jsx)(`span`,{className:`sun`}),(0,k.jsx)(`img`,{src:A(`assets/mascot.webp`),alt:`芽芽欢迎你`})]}),(0,k.jsxs)(`div`,{className:`step-dots`,children:[(0,k.jsx)(`i`,{className:t>=0?`on`:``}),(0,k.jsx)(`i`,{className:t>=1?`on`:``}),(0,k.jsx)(`i`,{className:t>=2?`on`:``})]}),t===0&&(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`h1`,{children:`欢迎来到小芽计划`}),(0,k.jsx)(`p`,{children:`先花一分钟了解你们的生活节奏，我们会准备更合适的亲子活动。`}),(0,k.jsxs)(`button`,{className:`primary wide`,onClick:()=>n(1),children:[`开始设置 `,(0,k.jsx)(j,{name:`arrow`,size:18})]})]}),t===1&&(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`h1`,{children:`怎么称呼小朋友？`}),(0,k.jsx)(`p`,{children:`只需要一个家里的小名，再选择年龄来匹配合适的活动。`}),(0,k.jsxs)(`label`,{className:`field`,children:[(0,k.jsx)(`span`,{children:`孩子昵称`}),(0,k.jsx)(`input`,{value:r,onChange:e=>i(e.target.value),placeholder:`例如：小树`})]}),(0,k.jsxs)(`div`,{className:`onboard-age`,children:[(0,k.jsx)(`span`,{children:`孩子年龄`}),(0,k.jsx)(`div`,{children:[2,3,4,5,6].map(e=>(0,k.jsxs)(`button`,{className:a===e?`active`:``,onClick:()=>o(e),children:[e,`岁`]},e))}),(0,k.jsx)(`small`,{children:`以后可以在设置中修改，推荐活动会跟着变化。`})]}),(0,k.jsxs)(`button`,{className:`primary wide`,onClick:()=>n(2),children:[`下一步 `,(0,k.jsx)(j,{name:`arrow`,size:18})]})]}),t===2&&(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`h1`,{children:`最近喜欢什么？`}),(0,k.jsx)(`p`,{children:`选几个就好，之后随时可以调整。`}),(0,k.jsx)(`div`,{className:`choice-cloud`,children:[`画画`,`音乐`,`绘本`,`车辆`,`水和沙子`,`做饭`,`植物`,`搭建`,`角色扮演`,`户外散步`].map(e=>(0,k.jsx)(`button`,{className:s.includes(e)?`selected`:``,onClick:()=>c(s.includes(e)?s.filter(t=>t!==e):[...s,e]),children:e},e))}),(0,k.jsxs)(`button`,{className:`primary wide`,onClick:()=>e(r||`小芽`,a),children:[`生成第一周计划 `,(0,k.jsx)(j,{name:`leaf`,size:18})]}),(0,k.jsx)(`small`,{className:`privacy`,children:`孩子信息只保存在当前设备`})]})]})})}function Je({activity:e,className:t=``}){let n=(e.visualIndex*47+18)%360,r={"--art-hue":`${n}`,"--art-hue-two":`${(n+48)%360}`};return(0,k.jsxs)(`span`,{className:`activity-picture ${t}`,style:r,"aria-label":`${e.title}专属插图`,children:[(0,k.jsx)(`i`,{className:`art-spark`,children:e.accentEmoji}),(0,k.jsx)(`b`,{children:e.emoji}),(0,k.jsx)(`small`,{children:String(e.number).padStart(3,`0`)})]})}function Ye({data:e,mood:t,onMood:n,activities:r,completed:i,completions:a,onOpen:o,onReplace:s,onRecord:c,onNavigate:l,ritualWater:u,onRitual:d}){let f=t===`有点累`||t===`需要放松`||t===`有点忙碌`?r.slice(0,2):r,p=[`如果今天是一种颜色，你觉得是什么颜色？为什么？`,`如果袜子会说话，它最想去哪里旅行？`,`今天有什么小事情让你觉得暖暖的？`],[m,h]=(0,_.useState)(0);return(0,k.jsxs)(`section`,{className:`page today-page`,children:[(0,k.jsxs)(`div`,{className:`warm-hero`,children:[(0,k.jsx)(`div`,{className:`hello-avatar`,children:(0,k.jsx)(Ge,{data:e,size:62})}),(0,k.jsxs)(`div`,{className:`hero-text`,children:[(0,k.jsx)(`p`,{className:`date-line`,children:Re}),(0,k.jsxs)(`h1`,{children:[Le,`好，`,e.nickname,(0,k.jsx)(`span`,{children:`☀`})]}),(0,k.jsx)(`p`,{children:`不用赶进度，今天也会有自己的小惊喜。`})]}),(0,k.jsx)(`img`,{src:A(`assets/mascot.webp`),alt:`芽芽坐在花盆边`,fetchPriority:`high`})]}),(0,k.jsxs)(`section`,{className:`mood-band`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h2`,{children:`家长能量`}),(0,k.jsx)(`p`,{children:`今天的你感觉怎么样？`})]}),(0,k.jsx)(`div`,{className:`mood-grid`,children:Be.map(e=>(0,k.jsxs)(`button`,{className:t===e.value?`active`:``,onClick:()=>n(e.value),children:[(0,k.jsx)(`span`,{children:(0,k.jsx)(j,{name:e.icon})}),(0,k.jsx)(`strong`,{children:e.value}),(0,k.jsx)(`small`,{children:e.hint})]},e.value))})]}),e.reminders?(0,k.jsxs)(`section`,{className:`gentle-reminder`,"aria-label":`首页温和提示`,children:[(0,k.jsx)(`span`,{children:(0,k.jsx)(j,{name:`sparkle`,size:19})}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:`今天的温和提示`}),(0,k.jsxs)(`p`,{children:[`不用把计划全部完成，有空时陪 `,e.nickname,` 选一个 5 分钟活动就很好。`]})]})]}):null,(0,k.jsxs)(`div`,{className:`section-heading`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`span`,{className:`basket-icon`,children:`▰`}),(0,k.jsx)(`h2`,{children:`今日成长篮子`})]}),(0,k.jsxs)(`small`,{children:[f.length,` 个小活动`]})]}),(0,k.jsx)(`div`,{className:`today-basket`,children:f.map((e,t)=>{let n=a.some(t=>t.activityId===e.id&&t.date===Ie);return(0,k.jsxs)(`article`,{className:`basket-card ${n?`done`:``}`,children:[(0,k.jsxs)(`button`,{className:`basket-main`,onClick:()=>o(e),children:[(0,k.jsx)(Je,{activity:e}),(0,k.jsx)(`strong`,{children:e.title}),(0,k.jsxs)(`small`,{children:[e.category,` · `,e.durationLabel,` · `,e.minAge,`–`,e.maxAge,`岁`]})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`button`,{"aria-label":`更换${e.title}`,onClick:()=>s(e.id),children:(0,k.jsx)(j,{name:`swap`,size:16})}),n?(0,k.jsx)(`button`,{className:`basket-done`,"aria-label":`已完成`,children:(0,k.jsx)(j,{name:`check`,size:17})}):(0,k.jsx)(`button`,{className:`basket-start`,onClick:()=>c(e),children:`开始`})]})]},e.id)})}),(0,k.jsxs)(`section`,{className:`daily-ritual ${u>0?`watered`:``}`,children:[(0,k.jsxs)(`div`,{className:`ritual-visual`,children:[(0,k.jsx)(Je,{activity:D.find(e=>e.title===`植物喝水了吗`)||D[0]}),(0,k.jsx)(`span`,{className:`ritual-water-gauge`,"aria-label":`今日浇水 ${u} 次`,children:(0,k.jsx)(`i`,{style:{height:`${12+u*17}%`}})}),(0,k.jsxs)(`b`,{children:[u,`/5`]}),u>0?(0,k.jsx)(`em`,{children:`💧`},u):null]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`small`,{children:`今日小仪式`}),(0,k.jsx)(`h3`,{children:u===5?`小芽今天喝饱水啦`:`一起给小芽浇浇水吧`}),(0,k.jsxs)(`p`,{children:[u,`/5 滴水 · 每次一点点就好`]})]}),(0,k.jsx)(`button`,{disabled:u===5,onClick:d,children:u===0?`开始`:u===5?`已喝饱`:`再浇一点`})]}),(0,k.jsxs)(`section`,{className:`conversation-card`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`small`,{children:`亲子一句话`}),(0,k.jsxs)(`blockquote`,{children:[`“`,p[m],`”`]})]}),(0,k.jsx)(`button`,{"aria-label":`换一个亲子话题`,onClick:()=>h((m+1)%p.length),children:(0,k.jsx)(j,{name:`swap`})})]}),(0,k.jsxs)(`section`,{className:`garden-preview`,children:[(0,k.jsxs)(`div`,{className:`garden-preview-copy`,children:[(0,k.jsx)(`small`,{children:`我们的成长小花园`}),(0,k.jsx)(`h3`,{children:i===0?`今天也留一块柔软的空地`:i<3?`新叶子正在慢慢舒展开`:`今天开了一朵小花`}),(0,k.jsx)(`p`,{children:`连续陪伴 18 天 · 不要求打卡`}),(0,k.jsx)(`div`,{className:`week-dots`,children:Pe.map((e,t)=>(0,k.jsx)(`span`,{className:t<Math.min(7,i+4)?`done`:``,children:t<Math.min(7,i+4)?`✓`:`·`},e))})]}),(0,k.jsxs)(`button`,{onClick:()=>l(`records`),children:[`看看花园 `,(0,k.jsx)(j,{name:`arrow`,size:16})]})]})]})}var Xe=[{id:`morning`,title:`早晨流程`,subtitle:`开启元气满满的一天`,emoji:`☀️`,tone:`sunrise`,tip:`固定的小步骤会带来安全感；不催促，完成三项也很棒。`,steps:[{id:`weather`,title:`看天气`,note:`看看窗外，用一个词形容今天`,emoji:`🌤️`},{id:`clothes`,title:`选择衣服`,note:`按天气挑衣服，练习自己决定`,emoji:`👕`},{id:`hello`,title:`英语问候`,note:`一起说一句简单的早安`,emoji:`💬`,english:{english:`Good morning!`,chinese:`早上好！`}},{id:`wash`,title:`自己刷牙洗脸`,note:`按顺序完成自己的清洁任务`,emoji:`🪥`},{id:`choose`,title:`选一个今日活动`,note:`让孩子从成长篮子里自己挑选`,emoji:`🧺`}]},{id:`cooking`,title:`做饭流程`,subtitle:`一起动手，好吃又开心`,emoji:`🍲`,tone:`apricot`,tip:`切、烫、加热由成人完成；孩子负责闻、数、搅拌和摆放。`,steps:[{id:`ingredients`,title:`认识食材`,note:`说出名称、颜色和来自哪里`,emoji:`🥕`},{id:`sort`,title:`数量与分类`,note:`数一数，再按颜色或种类分一分`,emoji:`🔢`},{id:`smell`,title:`闻一闻味道`,note:`用香、甜、清新等词来描述`,emoji:`👃`},{id:`verbs`,title:`英语动作词`,note:`边做边说一个厨房动作`,emoji:`🔤`,english:{english:`Mix, mix, mix!`,chinese:`搅一搅，搅一搅！`}},{id:`help`,title:`帮忙搅拌或摆放`,note:`完成一个安全的小帮手任务`,emoji:`🥄`}]},{id:`outing`,title:`出门流程`,subtitle:`有计划，出门不慌乱`,emoji:`🎒`,tone:`sky`,tip:`让孩子负责一件固定物品；过马路时牵手并由成人做最终安全判断。`,steps:[{id:`weather`,title:`看天气`,note:`决定要不要带帽子、外套或雨具`,emoji:`☁️`},{id:`bag`,title:`准备小背包`,note:`水、纸巾和任务卡逐项确认`,emoji:`🎒`},{id:`transport`,title:`认识交通工具`,note:`观察今天会搭乘或看见什么`,emoji:`🚌`},{id:`safety`,title:`说一遍安全规则`,note:`牵手、停看听、不离开大人视线`,emoji:`🛡️`},{id:`observe`,title:`户外观察任务`,note:`带着外出任务卡去发现`,emoji:`🔎`,english:{english:`What can you see?`,chinese:`你看见了什么？`}}]},{id:`bedtime`,title:`睡前流程`,subtitle:`慢下来，安心进入梦乡`,emoji:`🌙`,tone:`lilac`,tip:`顺序比速度更重要；重复、稳定的睡前流程能帮助孩子慢下来。`,steps:[{id:`tidy`,title:`收玩具`,note:`一次收一类，给玩具说晚安`,emoji:`🧸`},{id:`review`,title:`回顾今天`,note:`说一件开心或印象深刻的事`,emoji:`💭`},{id:`mood`,title:`情绪天气`,note:`今天的心情像晴天、阴天还是雨天？`,emoji:`🌦️`},{id:`book`,title:`睡前绘本`,note:`慢慢读一本喜欢的故事`,emoji:`📖`},{id:`goodnight`,title:`一句英语晚安`,note:`拥抱后轻轻说晚安`,emoji:`✨`,english:{english:`Good night. Sweet dreams!`,chinese:`晚安，做个好梦！`}}]}];function Ze(e){if(!(`speechSynthesis`in window))return!1;window.speechSynthesis.cancel();let t=new SpeechSynthesisUtterance(e);return t.lang=`en-US`,t.rate=.78,t.pitch=1.05,window.speechSynthesis.speak(t),!0}var Qe=e=>e.replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]||e);function $e(e,t,n,r){let i=window.open(``,`_blank`);if(!i)return!1;i.opener=null;let a=r.flat().map(e=>e.activityId?D.find(t=>t.id===e.activityId):void 0).filter(e=>!!e?.englishGuide),o=(a.length?a:D.filter(e=>e.englishGuide)).slice(0,6),s={today:`今日活动卡`,week:`本周计划表`,english:`英语词汇小卡`,outing:`外出任务卡`},c=``;return e===`today`&&(c=`<div class="cards">${n.map(e=>`<article><div class="label">小芽计划 · ${Qe(t)}的今日活动</div><h2>${Qe(e.title)}</h2><p><b>材料：</b>${Qe(e.materials.join(`、`)||`不需要额外材料`)}</p><h3>三步玩法</h3><ol>${e.steps.slice(0,3).map(e=>`<li>${Qe(e)}</li>`).join(``)}</ol><p><b>家长可以说：</b>“${Qe(e.opening)}”</p><p class="safety"><b>安全提醒：</b>${Qe(e.safety||`保持在成人视线内，尊重孩子想暂停的信号。`)}</p></article>`).join(``)}</div>`),e===`week`&&(c=`<table><thead><tr><th>时间</th>${Pe.map(e=>`<th>${e}</th>`).join(``)}</tr></thead><tbody>${_e.map(e=>`<tr><th>${e}</th>${r.map(t=>`<td>${t.filter(t=>t.slot===e).map(e=>Qe(e.title)).join(`<br>`)||`留白 / 休息`}</td>`).join(``)}</tr>`).join(``)}</tbody></table><p class="footnote">提示：游戏、家务、自由玩、吃饭与休息，都是家庭学习的一部分。</p>`),e===`english`&&(c=`<div class="word-cards">${o.flatMap(e=>e.englishGuide.words.slice(0,3).map(t=>`<article><div class="picture">${e.emoji}</div><h2>${Qe(t.word)}</h2><p>${Qe(t.meaning)}</p><div><b>简单句</b><br>${Qe(e.englishGuide.sentences[0]?.english||`Let’s play!`)}<br><small>${Qe(e.englishGuide.sentences[0]?.chinese||`我们来玩吧！`)}</small></div><div><b>本周游戏</b><br>${Qe(e.title)}</div></article>`)).join(``)}</div>`),e===`outing`&&(c=`<article class="outing"><div class="label">小芽计划 · 外出探索</div><h2>今天去公园，我要找一找</h2><ul><li>□ 找到三种绿色</li><li>□ 听到两种声音</li><li>□ 看到一只小动物</li><li>□ 说一句英语：I see a ______.</li></ul><div class="notes"><b>我的新发现</b><br><br>________________________________<br><br>________________________________</div><p class="safety"><b>安全约定：</b>牵好大人的手，停下来再观察，不独自离开。</p></article>`),i.document.write(`<!doctype html><html lang="zh-CN"><head><meta charset="UTF-8"><title>${s[e]} · 小芽计划</title><style>@page{size:A4;margin:12mm}*{box-sizing:border-box}body{font-family:"Microsoft YaHei",Arial,sans-serif;color:#222;margin:0;font-size:12pt}header{display:flex;justify-content:space-between;align-items:end;border-bottom:2px solid #222;padding-bottom:8px;margin-bottom:14px}header h1{margin:0;font-size:22pt}header p{margin:0}.cards{display:grid;grid-template-columns:1fr 1fr;gap:10mm}.cards article,.word-cards article,.outing{border:1.5px solid #222;border-radius:10px;padding:8mm;break-inside:avoid}.cards h2,.outing h2{margin:5px 0 8px}.cards h3{font-size:12pt;margin:9px 0 4px}.cards p{line-height:1.55}.label{font-size:9pt;letter-spacing:1px}.safety{border-top:1px dashed #555;padding-top:7px}table{width:100%;border-collapse:collapse;table-layout:fixed}th,td{border:1px solid #222;padding:7px;vertical-align:top;font-size:9.5pt;line-height:1.45}th{font-weight:700}.footnote{text-align:center;margin-top:12px}.word-cards{display:grid;grid-template-columns:repeat(3,1fr);gap:7mm}.word-cards article{text-align:center;min-height:74mm}.word-cards .picture{font-size:32pt;filter:grayscale(1)}.word-cards h2{font-size:22pt;margin:4px}.word-cards p{font-size:14pt;margin:2px 0 12px}.word-cards article div{margin-top:10px;line-height:1.5}.outing{max-width:170mm;margin:auto}.outing ul{list-style:none;padding:0;font-size:17pt;line-height:2.35}.notes{border:1px solid #555;padding:8mm;margin:8mm 0;line-height:1.8}@media print{button{display:none}} </style></head><body><header><h1>${s[e]}</h1><p>${Qe(Re)}</p></header>${c}<script>window.onload=()=>setTimeout(()=>window.print(),250)<\/script></body></html>`),i.document.close(),!0}function et({plan:e,onPlan:t,onOpen:n,notify:r,nickname:i,childAge:a,todayActivities:o,routineChecks:s,onRoutineChecks:c}){let l=(new Date().getDay()+6)%7,[u,d]=(0,_.useState)(`week`),[f,p]=(0,_.useState)(l),[m,h]=(0,_.useState)(null),g=e[f]||[],v=e.flat().filter(e=>e.kind===`activity`).length,y=e.flat().length-v,b=new Set(e.flat().map(e=>e.activityId&&D.find(t=>t.id===e.activityId)?.category).filter(Boolean)).size,x=Math.round(e.reduce((e,t)=>e+t.reduce((e,t)=>e+t.duration,0),0)/7),ee=()=>{t(we(Math.floor(Math.random()*D.length),a)),r(`已经按 ${a} 岁重新安排活动与休息`)},S=n=>{t(e.map((e,t)=>t===f?e.filter(e=>e.uid!==n):[...e])),r(`已经从这一天移除`)},C=n=>{m&&(t(e.map((e,t)=>t===m.day?[...e,{uid:`activity-${Date.now()}-${n.number}`,kind:`activity`,slot:m.slot,activityId:n.id,title:n.title,duration:n.duration}]:[...e])),O(`plan_item_added`,{...Me(n,`weekly_plan`),item_kind:`activity`,slot:m.slot}),r(`已把「${n.title}」加入${m.slot}`))},te=n=>{m&&(t(e.map((e,t)=>t===m.day?[...e,{uid:`rhythm-${Date.now()}-${n.kind}`,kind:n.kind,slot:m.slot,title:n.title,duration:n.duration}]:[...e])),O(`plan_item_added`,{source:`weekly_plan`,item_kind:n.kind,slot:m.slot}),r(`已加入「${n.title}」`))},ne={week:[`玩一会儿，也好好休息`,`本周生活课表`],routines:[`把真实生活变成课程`,`生活流程课`],print:[`贴在冰箱上也能用`,`打印中心`]};return(0,k.jsxs)(`section`,{className:`page plan-page`,children:[(0,k.jsxs)(`div`,{className:`planner-tabs`,role:`tablist`,"aria-label":`计划工具`,children:[(0,k.jsx)(`button`,{role:`tab`,"aria-selected":u===`week`,className:u===`week`?`active`:``,onClick:()=>d(`week`),children:`周课表`}),(0,k.jsx)(`button`,{role:`tab`,"aria-selected":u===`routines`,className:u===`routines`?`active`:``,onClick:()=>d(`routines`),children:`生活流程`}),(0,k.jsx)(`button`,{role:`tab`,"aria-selected":u===`print`,className:u===`print`?`active`:``,onClick:()=>d(`print`),children:`打印中心`})]}),(0,k.jsxs)(`div`,{className:`title-row planner-title`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`p`,{className:`date-line`,children:ne[u][0]}),(0,k.jsx)(`h1`,{children:ne[u][1]})]}),u===`week`?(0,k.jsx)(`button`,{className:`icon-button`,onClick:ee,"aria-label":`重新生成`,children:(0,k.jsx)(j,{name:`swap`})}):(0,k.jsx)(`img`,{src:A(`assets/mascot.webp`),alt:`芽芽陪你安排生活课程`})]}),u===`week`&&(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(`section`,{className:`week-theme`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`small`,{children:`这周的小提醒`}),(0,k.jsx)(`h2`,{children:`不用把一天排满`}),(0,k.jsx)(`p`,{children:`同一时段可以安排多个游戏，也可以穿插喝水、家务、自由玩和午睡。`}),(0,k.jsx)(`button`,{onClick:ee,children:`换一份温柔节奏`})]}),(0,k.jsx)(`img`,{src:A(`assets/mascot.webp`),alt:`芽芽举着小风车`})]}),(0,k.jsxs)(`div`,{className:`plan-summary`,children:[(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`strong`,{children:v}),(0,k.jsx)(`small`,{children:`个不同活动`})]}),(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`strong`,{children:y}),(0,k.jsx)(`small`,{children:`个休息与生活块`})]}),(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`strong`,{children:x}),(0,k.jsx)(`small`,{children:`分钟 / 天（含休息）`})]})]}),(0,k.jsxs)(`div`,{className:`soft-advice`,children:[(0,k.jsx)(j,{name:`sparkle`}),(0,k.jsxs)(`span`,{children:[`本周覆盖 `,b,` 个成长领域；休息与自由玩也属于孩子的重要课程。`]})]}),(0,k.jsx)(`div`,{className:`week-day-tabs`,role:`tablist`,children:Pe.map((t,n)=>{let r=(e[n]||[]).filter(e=>e.kind===`activity`).length;return(0,k.jsxs)(`button`,{role:`tab`,"aria-selected":f===n,className:`${f===n?`active`:``} ${n===l?`today`:``}`,onClick:()=>p(n),children:[(0,k.jsx)(`strong`,{children:t.slice(1)}),(0,k.jsxs)(`small`,{children:[r,`项`]}),n===l&&(0,k.jsx)(`i`,{children:`今`})]},t)})}),(0,k.jsxs)(`section`,{className:`day-schedule`,children:[(0,k.jsxs)(`div`,{className:`schedule-heading`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsxs)(`small`,{children:[Pe[f],`的安排`]}),(0,k.jsx)(`h2`,{children:`游戏、生活与留白`})]}),(0,k.jsxs)(`span`,{children:[g.length,` 个安排`]})]}),_e.map(e=>{let t=g.filter(t=>t.slot===e);return(0,k.jsxs)(`section`,{className:`time-slot`,children:[(0,k.jsxs)(`header`,{children:[(0,k.jsx)(`span`,{children:e===`早餐后`?`☀️`:e===`上午`?`🌤️`:e===`午睡后`?`🌿`:e===`傍晚`?`🌇`:`🌙`}),(0,k.jsx)(`strong`,{children:e}),(0,k.jsxs)(`small`,{children:[t.reduce((e,t)=>e+t.duration,0),` 分钟`]}),(0,k.jsxs)(`button`,{onClick:()=>h({day:f,slot:e}),children:[(0,k.jsx)(j,{name:`plus`,size:16}),` 添加`]})]}),(0,k.jsx)(`div`,{className:`slot-items`,children:t.length===0?(0,k.jsx)(`button`,{className:`empty-slot`,onClick:()=>h({day:f,slot:e}),children:`这里留白也很好 · 点此添加`}):t.map(e=>{let t=e.activityId?D.find(t=>t.id===e.activityId):void 0;if(t)return(0,k.jsxs)(`article`,{className:`schedule-activity`,children:[(0,k.jsxs)(`button`,{className:`schedule-main`,onClick:()=>n(t),children:[(0,k.jsx)(Je,{activity:t}),(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`strong`,{children:t.title}),(0,k.jsxs)(`small`,{children:[t.category,` · `,t.durationLabel]})]})]}),(0,k.jsx)(`button`,{className:`remove-plan-item`,"aria-label":`移除${t.title}`,onClick:()=>S(e.uid),children:(0,k.jsx)(j,{name:`close`,size:16})})]},e.uid);let r=Te.find(t=>t.kind===e.kind&&t.title===e.title);return(0,k.jsxs)(`article`,{className:`schedule-rhythm ${e.kind}`,children:[(0,k.jsx)(`span`,{children:r?.emoji||`🤍`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:e.title}),(0,k.jsxs)(`small`,{children:[e.kind===`chore`?`小小家务`:e.kind===`free`?`自由玩耍`:e.kind===`meal`?`用餐时间`:e.kind===`nap`?`睡眠休息`:`休息留白`,` · `,e.duration,` 分钟`]})]}),(0,k.jsx)(`button`,{className:`remove-plan-item`,"aria-label":`移除${e.title}`,onClick:()=>S(e.uid),children:(0,k.jsx)(j,{name:`close`,size:16})})]},e.uid)})})]},e)})]})]}),u===`routines`&&(0,k.jsx)(tt,{checks:s,onChecks:c,notify:r}),u===`print`&&(0,k.jsx)(nt,{nickname:i,todayActivities:o,plan:e,notify:r}),u===`week`&&m&&(0,k.jsx)(rt,{slot:m.slot,childAge:a,existingIds:g.filter(e=>e.slot===m.slot).map(e=>e.activityId).filter(Boolean),onAddActivity:C,onAddRhythm:te,onClose:()=>h(null)})]})}function tt({checks:e,onChecks:t,notify:n}){let[r,i]=(0,_.useState)(`morning`),a=(n,r)=>{let i=e[n]||[],a=i.includes(r)?i.filter(e=>e!==r):[...i,r];t({...e,[n]:a});let o=Xe.find(e=>e.id===n);O(`routine_step_toggled`,{routine_id:n,step_index:Math.max(0,o?.steps.findIndex(e=>e.id===r)??0)+1,completed:a.includes(r)})};return(0,k.jsxs)(`div`,{className:`routine-courses`,children:[(0,k.jsxs)(`section`,{className:`routine-intro`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`span`,{children:`每天都会发生的学习`}),(0,k.jsx)(`h2`,{children:`不用特意“上课”`}),(0,k.jsx)(`p`,{children:`观察、选择、整理和聊天，都能自然长出语言、逻辑与生活能力。`})]}),(0,k.jsx)(`img`,{src:A(`assets/mascot.webp`),alt:`芽芽准备开始生活流程`})]}),(0,k.jsxs)(`div`,{className:`routine-howto`,children:[(0,k.jsx)(`span`,{children:`👉`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:`这样使用`}),(0,k.jsx)(`p`,{children:`先点开一个流程卡，再点击每一步左侧的圆圈完成勾选；进度会自动保存，并在第二天重新开始。`})]})]}),Xe.map(t=>{let o=e[t.id]||[],s=r===t.id;return(0,k.jsxs)(`article`,{className:`routine-card ${t.tone} ${s?`open`:``}`,children:[(0,k.jsxs)(`button`,{className:`routine-heading`,"aria-expanded":s,onClick:()=>i(s?``:t.id),children:[(0,k.jsx)(`span`,{className:`routine-emoji`,children:t.emoji}),(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`strong`,{children:t.title}),(0,k.jsx)(`small`,{children:t.subtitle})]}),(0,k.jsxs)(`em`,{children:[o.length,`/`,t.steps.length,` 完成`]}),(0,k.jsx)(j,{name:`arrow`,size:18})]}),s&&(0,k.jsxs)(`div`,{className:`routine-body`,children:[(0,k.jsx)(`div`,{className:`routine-progress`,children:(0,k.jsx)(`i`,{style:{width:`${o.length/t.steps.length*100}%`}})}),(0,k.jsx)(`ol`,{children:t.steps.map((e,r)=>{let i=o.includes(e.id);return(0,k.jsxs)(`li`,{className:i?`done`:``,children:[(0,k.jsx)(`button`,{className:`routine-check`,"aria-label":`${i?`取消完成`:`完成`}${e.title}`,onClick:()=>a(t.id,e.id),children:i?(0,k.jsx)(j,{name:`check`,size:16}):r+1}),(0,k.jsx)(`span`,{className:`routine-step-emoji`,children:e.emoji}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:e.title}),(0,k.jsx)(`small`,{children:e.note}),e.english&&(0,k.jsxs)(`button`,{className:`mini-speech`,onClick:()=>{Ze(e.english.english)||n(`当前浏览器暂不支持语音朗读`)},children:[(0,k.jsx)(`span`,{children:e.english.english}),(0,k.jsx)(j,{name:`volume`,size:17})]})]})]},e.id)})}),(0,k.jsxs)(`aside`,{children:[(0,k.jsx)(`span`,{children:`♡`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:`给家长的小建议`}),(0,k.jsx)(`p`,{children:t.tip})]})]})]})]},t.id)})]})}function nt({nickname:e,todayActivities:t,plan:n,notify:r}){let i=[{kind:`today`,title:`今日活动卡`,desc:`材料、三步玩法、家长话术和安全提醒`,emoji:`🗂️`,tone:`sunrise`},{kind:`week`,title:`本周计划表`,desc:`一周安排清晰可见，游戏和休息都能看见`,emoji:`🗓️`,tone:`sky`},{kind:`english`,title:`英语词汇小卡`,desc:`单词、中文、简单句和对应的本周游戏`,emoji:`🔤`,tone:`blush`},{kind:`outing`,title:`外出任务卡`,desc:`出门带任务，观察世界，收获成长`,emoji:`🎒`,tone:`mint`}],a=(i,a)=>{$e(i,e,t,n)?(O(`print_card_opened`,{print_type:i}),r(`${a}已打开，可打印或保存为 PDF`)):r(`浏览器阻止了打印窗口，请允许弹出窗口后重试`)};return(0,k.jsxs)(`div`,{className:`print-center`,children:[(0,k.jsxs)(`section`,{className:`print-intro`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`span`,{children:`从屏幕回到生活`}),(0,k.jsx)(`h2`,{children:`不用一直拿着手机`}),(0,k.jsx)(`p`,{children:`打印出来贴在冰箱或墙上，孩子也能自己看懂下一步。`})]}),(0,k.jsx)(`span`,{className:`desk-printer`,children:(0,k.jsx)(j,{name:`printer`,size:34})})]}),(0,k.jsx)(`div`,{className:`print-list`,children:i.map(e=>(0,k.jsxs)(`article`,{className:e.tone,children:[(0,k.jsx)(`span`,{className:`print-illustration`,children:e.emoji}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h3`,{children:e.title}),(0,k.jsx)(`p`,{children:e.desc}),(0,k.jsxs)(`button`,{onClick:()=>a(e.kind,e.title),children:[(0,k.jsx)(j,{name:`printer`,size:16}),` 预览并打印`]})]})]},e.kind))})]})}function rt({slot:e,childAge:t,existingIds:n,onAddActivity:r,onAddRhythm:i,onClose:a}){let[o,s]=(0,_.useState)(``),[c,l]=(0,_.useState)(`全部`),u=D.filter(e=>ve(e,t)&&(c===`全部`||e.category===c)&&(e.title.includes(o)||e.summary.includes(o)||e.materials.join(``).includes(o))).slice(0,40);return(0,k.jsx)(`div`,{className:`modal-backdrop`,onMouseDown:a,children:(0,k.jsxs)(`article`,{className:`sheet schedule-picker`,onMouseDown:e=>e.stopPropagation(),children:[(0,k.jsxs)(`button`,{className:`sheet-back`,"aria-label":`返回计划`,onClick:a,children:[(0,k.jsx)(j,{name:`back`}),(0,k.jsx)(`span`,{children:`返回计划`})]}),(0,k.jsxs)(`div`,{className:`picker-heading`,children:[(0,k.jsxs)(`small`,{children:[`正在安排 · 为 `,t,` 岁筛选`]}),(0,k.jsxs)(`h2`,{children:[e,`可以选多个项目`]}),(0,k.jsx)(`p`,{children:`添加后不会自动关闭，可以继续选择游戏、休息或家务。`})]}),(0,k.jsxs)(`section`,{className:`rhythm-picker`,children:[(0,k.jsx)(`h3`,{children:`先放好生活节奏`}),(0,k.jsx)(`div`,{children:Te.map(e=>(0,k.jsxs)(`button`,{onClick:()=>i(e),children:[(0,k.jsx)(`span`,{children:e.emoji}),(0,k.jsx)(`strong`,{children:e.title}),(0,k.jsxs)(`small`,{children:[e.duration,`分钟`]})]},`${e.kind}-${e.title}`))})]}),(0,k.jsxs)(`label`,{className:`search-box`,children:[(0,k.jsx)(j,{name:`search`}),(0,k.jsx)(`input`,{value:o,onChange:e=>s(e.target.value),placeholder:`搜索 ${D.length} 个不同活动`})]}),(0,k.jsx)(`div`,{className:`filter-scroll picker-filters`,children:ge.map(e=>(0,k.jsx)(`button`,{className:c===e?`active`:``,onClick:()=>l(e),children:e},e))}),(0,k.jsx)(`div`,{className:`picker-list`,children:u.map(e=>(0,k.jsxs)(`article`,{children:[(0,k.jsx)(Je,{activity:e}),(0,k.jsxs)(`button`,{className:`picker-copy`,onClick:()=>r(e),children:[(0,k.jsx)(`strong`,{children:e.title}),(0,k.jsxs)(`small`,{children:[e.category,` · `,e.durationLabel,` · `,e.minAge,`–`,e.maxAge,`岁`]})]}),(0,k.jsx)(`button`,{className:n.includes(e.id)?`added`:``,disabled:n.includes(e.id),onClick:()=>r(e),children:n.includes(e.id)?`已添加`:`＋ 添加`})]},e.id))}),(0,k.jsx)(`button`,{className:`primary wide sticky-action`,onClick:a,children:`完成这个时段`})]})})}function it({favorites:e,savedOnly:t,childAge:n,onSavedOnly:r,onFavorites:i,onOpen:a,onAdd:o}){let[s,c]=(0,_.useState)(``),[l,u]=(0,_.useState)(``),[d,f]=(0,_.useState)(`全部`),[p,m]=(0,_.useState)(n),[h,g]=(0,_.useState)(null),v=(0,_.useRef)(null);(0,_.useEffect)(()=>m(n),[n]);let y=(0,_.useMemo)(()=>D.filter(n=>(!t||e.includes(n.id))&&(t||p===`all`||ve(n,p))&&(d===`全部`||n.category===d)&&(n.title.includes(l)||n.summary.includes(l)||n.materials.join(``).includes(l)||n.series.includes(l))),[l,d,p,t,e]),b=()=>{window.requestAnimationFrame(()=>window.requestAnimationFrame(()=>v.current?.scrollIntoView({behavior:`smooth`,block:`start`})))},x=e=>{c(``),u(``),r(!1),f(e),b()},ee=e=>{e.preventDefault();let t=s.trim();u(t),f(`全部`),r(!1),O(`search_used`,{result_count:D.filter(e=>e.title.includes(t)||e.summary.includes(t)||e.materials.join(``).includes(t)||e.series.includes(t)).length}),b()},S=(0,k.jsx)(`div`,{className:`library-list`,children:y.map(t=>(0,k.jsxs)(`article`,{className:`library-card`,children:[(0,k.jsx)(`button`,{className:`library-picture-button`,"aria-label":`${t.title}插图`,onClick:()=>a(t),children:(0,k.jsx)(Je,{activity:t})}),(0,k.jsxs)(`button`,{className:`library-copy`,onClick:()=>a(t),children:[(0,k.jsx)(`strong`,{children:t.title}),(0,k.jsxs)(`small`,{children:[t.category,` · `,t.durationLabel]}),(0,k.jsxs)(`span`,{className:`activity-age-tag`,children:[t.minAge,`–`,t.maxAge,`岁 · `,t.difficulty]}),(0,k.jsx)(`p`,{children:t.summary})]}),(0,k.jsx)(`button`,{className:`heart-button ${e.includes(t.id)?`active`:``}`,"aria-label":e.includes(t.id)?`取消收藏`:`收藏`,onClick:()=>{let n=!e.includes(t.id);i(n?[...e,t.id]:e.filter(e=>e!==t.id)),O(`activity_saved`,{...Me(t,`activity_library`),saved:n})},children:(0,k.jsx)(j,{name:`heart`,size:19})}),(0,k.jsxs)(`button`,{className:`tiny-add`,onClick:()=>o(t),children:[(0,k.jsx)(j,{name:`plus`,size:17}),`今天`]})]},t.id))});return t?(0,k.jsxs)(`section`,{className:`page favorites-page`,children:[(0,k.jsxs)(`header`,{className:`favorites-page-header`,children:[(0,k.jsx)(`span`,{children:(0,k.jsx)(j,{name:`heart`,size:28})}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`p`,{children:`收藏与灵感`}),(0,k.jsx)(`h1`,{children:`我的收藏夹`}),(0,k.jsx)(`small`,{children:y.length>0?`这里收着 ${y.length} 个喜欢的活动`:`喜欢的活动会安静地收在这里`})]})]}),y.length===0?(0,k.jsxs)(`section`,{className:`favorites-empty`,children:[(0,k.jsx)(`span`,{children:`♡`}),(0,k.jsx)(`h3`,{children:`收藏夹还是空的`}),(0,k.jsx)(`p`,{children:`回到活动页，看到喜欢的活动时点一下爱心，它就会被收进这里。`}),(0,k.jsx)(`button`,{onClick:()=>x(`全部`),children:`去发现活动`})]}):S]}):(0,k.jsxs)(`section`,{className:`page library-page`,children:[(0,k.jsx)(`div`,{className:`title-row`,children:(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`p`,{className:`date-line`,children:`发现好玩的亲子时光`}),(0,k.jsx)(`h1`,{children:`活动发现`})]})}),(0,k.jsxs)(`form`,{className:`search-box library-search`,onSubmit:ee,children:[(0,k.jsx)(j,{name:`search`}),(0,k.jsx)(`input`,{"aria-label":`搜索活动、材料或场景`,value:s,onChange:e=>c(e.target.value),placeholder:`搜索活动、材料或场景`}),s?(0,k.jsx)(`button`,{type:`button`,className:`search-clear`,"aria-label":`清空搜索`,onClick:()=>{c(``),u(``)},children:(0,k.jsx)(j,{name:`close`,size:16})}):null,(0,k.jsx)(`button`,{className:`search-submit`,type:`submit`,children:`搜索`})]}),(0,k.jsxs)(`section`,{className:`age-filter-panel`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`span`,{children:`按年龄找活动`}),(0,k.jsx)(`strong`,{children:p===`all`?`正在查看全部年龄`:`正在为 ${p} 岁孩子推荐`})]}),(0,k.jsxs)(`div`,{children:[[2,3,4,5,6].map(e=>(0,k.jsxs)(`button`,{className:p===e?`active`:``,"aria-pressed":p===e,onClick:()=>{m(e),O(`age_filter_selected`,{age:e}),b()},children:[e,`岁`]},e)),(0,k.jsx)(`button`,{className:p===`all`?`active`:``,"aria-pressed":p===`all`,onClick:()=>{m(`all`),O(`age_filter_selected`,{age:`all`}),b()},children:`全部`})]}),(0,k.jsx)(`small`,{children:`同一个活动会按适龄范围出现，详情里还有轻松玩法和进阶玩法。`})]}),(0,k.jsx)(`div`,{className:`filter-scroll`,children:ge.map(e=>(0,k.jsx)(`button`,{className:!t&&d===e?`active`:``,onClick:()=>x(e),children:e},e))}),(0,k.jsxs)(`section`,{className:`english-series-banner`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`small`,{children:`EXPANDED · 独立启蒙系列`}),(0,k.jsx)(`h2`,{children:`游戏化英语活动`}),(0,k.jsx)(`p`,{children:`加入寻宝、表演、制作、运动、故事与亲子合作，用动作和真实生活自然开口。`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`span`,{children:`生活词汇与动作`}),(0,k.jsx)(`span`,{children:`剧情任务与亲子合作`})]}),(0,k.jsx)(`button`,{onClick:()=>x(`英语启蒙`),children:`进入英语启蒙并查看活动`})]}),(0,k.jsxs)(`span`,{className:`english-art`,children:[`A`,(0,k.jsx)(`span`,{children:`🌈`}),(0,k.jsx)(`b`,{children:`hello!`})]})]}),(0,k.jsxs)(`section`,{className:`theme-banner`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`small`,{children:`自然探索主题`}),(0,k.jsx)(`h2`,{children:`风、云、影子和小种子`}),(0,k.jsx)(`p`,{children:`从家门口开始观察，慢慢发现自然里的秘密。`}),(0,k.jsx)(`button`,{onClick:()=>x(`自然科学`),children:`查看主题并定位活动`})]}),(0,k.jsx)(`img`,{src:A(`assets/mascot.webp`),alt:`芽芽邀请你发现活动`})]}),(0,k.jsxs)(`div`,{className:`section-heading library-results-heading`,ref:v,children:[(0,k.jsx)(`div`,{children:(0,k.jsx)(`h2`,{children:d===`英语启蒙`?`英语启蒙活动`:l?`搜索结果`:p===`all`?`全部活动`:`${p} 岁精选活动`})}),(0,k.jsxs)(`small`,{children:[y.length,` 个`]})]}),y.length>0?S:(0,k.jsxs)(`section`,{className:`search-empty`,children:[(0,k.jsx)(`span`,{children:`🔎`}),(0,k.jsx)(`h3`,{children:`没有找到相关活动`}),(0,k.jsx)(`p`,{children:`换一个短一点的关键词试试，例如“袜子”“颜色”或“英语”。`})]}),(0,k.jsx)(`div`,{className:`library-tools single`,children:(0,k.jsxs)(`button`,{onClick:()=>{let e=y.length?y:D.filter(e=>p===`all`||ve(e,p));g(e[Math.floor(Math.random()*e.length)])},children:[(0,k.jsx)(`span`,{children:`🎲`}),(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`strong`,{children:h?h.title:`随机一个活动`}),(0,k.jsx)(`small`,{children:h?`再换一个惊喜`:`从当前年龄与类别里抽取`})]})]})}),h&&(0,k.jsxs)(`section`,{className:`surprise`,children:[(0,k.jsx)(`img`,{src:A(`assets/mascot.webp`),alt:`芽芽抽活动`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`small`,{children:`芽芽帮你选好了`}),(0,k.jsx)(`h3`,{children:h.title}),(0,k.jsx)(`p`,{children:h.summary})]}),(0,k.jsx)(`button`,{onClick:()=>a(h),children:`去看看`})]})]})}function at({completions:e,onExplore:t}){let n=[...e].filter(e=>e.quote?.trim()).reverse(),r=n[0]?.quote,[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)(null),[c,l]=(0,_.useState)(null),u=(e,t)=>l(n=>({id:e,message:t,tick:(n?.tick||0)+1})),d=[{id:`language`,emoji:`🌻`,title:`语言表达`,categories:[`语言表达`,`英语启蒙`],hint:`愿意多说一点`,next:`继续聊天、复述故事或玩英语动作游戏`},{id:`life`,emoji:`🍄`,title:`生活能力`,categories:[`生活能力`,`精细动作`,`大运动`],hint:`喜欢自己试试`,next:`把收拾、穿衣和小家务交给孩子一点点`},{id:`creative`,emoji:`🌼`,title:`艺术创造`,categories:[`艺术创造`,`音乐节奏`],hint:`有自己的想法`,next:`多提供开放材料，让孩子决定颜色、节奏和做法`},{id:`nature`,emoji:`🌳`,title:`自然观察`,categories:[`自然科学`,`空间认知`,`数量逻辑`],hint:`发现更多细节`,next:`出门带一张观察卡，比较、数一数、说说变化`}].map(t=>{let n=e.filter(e=>{let n=D.find(t=>t.id===e.activityId);return n?t.categories.includes(n.category):!1}).length,r=n===0?`正在发芽`:n<3?`冒出小叶`:n<6?`慢慢长高`:`开出小花`;return{...t,count:n,stage:r}}),f=d.find(e=>e.id===o);return(0,k.jsxs)(`section`,{className:`page garden-page`,children:[(0,k.jsxs)(`div`,{className:`garden-header`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`p`,{className:`date-line`,children:`记录我们一起成长的点滴`}),(0,k.jsx)(`h1`,{children:`成长花园`})]}),(0,k.jsx)(`img`,{src:A(`assets/mascot.webp`),alt:`芽芽在花园里`})]}),(0,k.jsxs)(`div`,{className:`growth-overview`,children:[(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`strong`,{children:`18`}),(0,k.jsx)(`small`,{children:`连续陪伴天数`})]}),(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`strong`,{children:e.length+6}),(0,k.jsx)(`small`,{children:`本周活动`})]}),(0,k.jsxs)(`button`,{"aria-expanded":i,"aria-controls":`garden-quote-collection`,onClick:()=>a(e=>!e),children:[(0,k.jsx)(`strong`,{children:n.length}),(0,k.jsx)(`small`,{children:`收藏的童言`}),(0,k.jsxs)(`em`,{children:[i?`收起`:`点开看看`,` `,(0,k.jsx)(j,{name:`arrow`,size:12})]})]})]}),i&&(0,k.jsxs)(`section`,{className:`quote-collection`,id:`garden-quote-collection`,children:[(0,k.jsxs)(`header`,{children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`small`,{children:`孩子自己的小小表达`}),(0,k.jsx)(`h2`,{children:`童言收藏`})]}),(0,k.jsx)(`button`,{"aria-label":`收起童言收藏`,onClick:()=>a(!1),children:(0,k.jsx)(j,{name:`close`,size:18})})]}),n.length>0?(0,k.jsx)(`div`,{children:n.slice(0,12).map((e,t)=>{let n=D.find(t=>t.id===e.activityId);return(0,k.jsxs)(`article`,{children:[(0,k.jsx)(`span`,{children:`“`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`blockquote`,{children:e.quote}),(0,k.jsxs)(`small`,{children:[e.date,n?` · ${n.title}`:``]})]})]},`${e.activityId}-${e.date}-${t}`)})}):(0,k.jsxs)(`div`,{className:`quote-empty`,children:[(0,k.jsx)(`span`,{children:`💬`}),(0,k.jsx)(`h3`,{children:`第一句话还在路上`}),(0,k.jsx)(`p`,{children:`完成活动后，在记录里写下孩子今天说过的话，它就会自动收藏在这里。`}),(0,k.jsx)(`button`,{onClick:t,children:`去挑一个活动`})]})]}),(0,k.jsxs)(`div`,{className:`month-summary`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`small`,{children:`本月一起完成`}),(0,k.jsxs)(`strong`,{children:[18+e.length,(0,k.jsx)(`span`,{children:`个活动`})]}),(0,k.jsx)(`p`,{children:`每一次陪伴，都是成长的养分。`})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`small`,{children:`孩子说过的话`}),(0,k.jsx)(`blockquote`,{children:r?`“${r}”`:`还没有收藏童言，完成活动时可以记下一句。`}),(0,k.jsx)(`span`,{children:r?`悄悄收藏进花园了`:`第一句话会从这里慢慢长出来`})]})]}),(0,k.jsxs)(`section`,{className:`garden-scene`,children:[(0,k.jsx)(`img`,{className:`garden-base`,src:A(`assets/garden.webp`),alt:`向日葵、小树、蘑菇和彩色花朵组成的成长花园`,fetchPriority:`high`}),c&&(0,k.jsx)(`img`,{className:`garden-awake-layer garden-${c.id}`,src:A(`assets/garden.webp`),alt:``,"aria-hidden":`true`},`${c.id}-${c.tick}`),(0,k.jsxs)(`div`,{className:`garden-hotspots`,children:[(0,k.jsx)(`button`,{className:`garden-hotspot hotspot-sunflower`,"aria-label":`轻触向日葵，让它长高一点`,onClick:()=>u(`sunflower`,`向日葵又长高一点啦`)}),(0,k.jsx)(`button`,{className:`garden-hotspot hotspot-tree`,"aria-label":`轻触小树，让它伸伸懒腰`,onClick:()=>u(`tree`,`小树伸了一个懒腰`)}),(0,k.jsx)(`button`,{className:`garden-hotspot hotspot-mushroom`,"aria-label":`轻触小蘑菇，让它跳一跳`,onClick:()=>u(`mushroom`,`小蘑菇开心地跳了跳`)}),(0,k.jsx)(`button`,{className:`garden-hotspot hotspot-flowers`,"aria-label":`轻触彩色花朵，让它们摇一摇`,onClick:()=>u(`flowers`,`彩色花朵轻轻摇摆起来`)})]}),(0,k.jsxs)(`div`,{className:`garden-tags`,children:[(0,k.jsx)(`span`,{children:`语言表达 · 向日葵`}),(0,k.jsx)(`span`,{children:`生活能力 · 小蘑菇`}),(0,k.jsx)(`span`,{children:`艺术创造 · 彩色花朵`})]}),c&&(0,k.jsxs)(`span`,{className:`garden-reaction reaction-${c.id}`,"aria-live":`polite`,children:[`✦ `,c.message]},`message-${c.id}-${c.tick}`),!c&&(0,k.jsx)(`small`,{className:`garden-touch-tip`,children:`轻轻点一点，看看花园会发生什么`}),(0,k.jsx)(`p`,{children:`慢慢长大，也很好。`})]}),(0,k.jsxs)(`section`,{className:`domain-section`,children:[(0,k.jsxs)(`div`,{className:`section-heading`,children:[(0,k.jsx)(`div`,{children:(0,k.jsx)(`h2`,{children:`这月长出的能力`})}),(0,k.jsx)(`small`,{children:`会随着记录慢慢变化`})]}),(0,k.jsx)(`div`,{className:`domain-grid`,children:d.map(e=>(0,k.jsxs)(`button`,{"aria-expanded":o===e.id,className:o===e.id?`active`:``,onClick:()=>s(o===e.id?null:e.id),children:[(0,k.jsx)(`span`,{children:e.emoji}),(0,k.jsx)(`strong`,{children:e.title}),(0,k.jsx)(`small`,{children:e.stage}),(0,k.jsxs)(`em`,{children:[e.count,` 次相关活动`]})]},e.id))}),f&&(0,k.jsxs)(`article`,{className:`domain-detail`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`span`,{children:f.emoji}),(0,k.jsxs)(`div`,{children:[(0,k.jsxs)(`small`,{children:[f.title,` · `,f.stage]}),(0,k.jsx)(`h3`,{children:f.hint})]})]}),(0,k.jsx)(`div`,{className:`domain-progress`,children:(0,k.jsx)(`i`,{style:{width:`${Math.min(100,16+f.count*14)}%`}})}),(0,k.jsxs)(`p`,{children:[`下一步可以：`,f.next,`。`]}),(0,k.jsx)(`p`,{className:`domain-note`,children:`这里不是评分，也不比较孩子；完成并记录相关活动后，文字与成长阶段会慢慢改变。`}),(0,k.jsxs)(`button`,{onClick:t,children:[`去找相关活动 `,(0,k.jsx)(j,{name:`arrow`,size:16})]})]})]}),(0,k.jsxs)(`div`,{className:`section-heading`,children:[(0,k.jsx)(`div`,{children:(0,k.jsx)(`h2`,{children:`最近记录`})}),(0,k.jsxs)(`button`,{onClick:t,children:[`去发现活动 `,(0,k.jsx)(j,{name:`arrow`,size:16})]})]}),e.length===0?(0,k.jsxs)(`div`,{className:`empty-note`,children:[(0,k.jsx)(`span`,{children:`🌱`}),(0,k.jsx)(`h3`,{children:`第一颗种子还在口袋里`}),(0,k.jsx)(`p`,{children:`完成一次活动后，可以从孩子今天说过的一句话开始记录。`}),(0,k.jsx)(`button`,{className:`secondary`,onClick:t,children:`挑一个小活动`})]}):(0,k.jsx)(`div`,{className:`record-list`,children:e.slice(-4).reverse().map((e,t)=>{let n=D.find(t=>t.id===e.activityId);return(0,k.jsxs)(`article`,{children:[(0,k.jsx)(`span`,{className:n.color,children:n.emoji}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:n.title}),(0,k.jsx)(`p`,{children:e.quote?`“${e.quote}”`:`今天${e.reaction}`}),(0,k.jsxs)(`small`,{children:[e.date,` · `,n.category]})]})]},`${e.activityId}-${t}`)})})]})}function ot({data:e,onData:t,onOpenFavorites:n,notify:r}){let i=(0,_.useRef)(null),a=n=>t({...e,...n}),o=e=>{if(!e)return;if(!e.type.startsWith(`image/`)){r(`请选择一张照片`);return}let t=new FileReader;t.onload=()=>{let e=new Image;e.onload=()=>{let t=document.createElement(`canvas`);t.width=256,t.height=256;let n=t.getContext(`2d`),i=Math.min(e.width,e.height);n.drawImage(e,(e.width-i)/2,(e.height-i)/2,i,i,0,0,256,256),a({avatarKind:`upload`,avatarData:t.toDataURL(`image/jpeg`,.82)}),r(`孩子头像已经换好`)},e.src=String(t.result)},t.readAsDataURL(e)},s=t=>a({activityTimes:e.activityTimes.includes(t)?e.activityTimes.filter(e=>e!==t):[...e.activityTimes,t]}),c=n=>{t({...e,age:n,todayIds:Ve(n),plan:we(n*17,n)}),O(`child_age_changed`,{age:n}),r(`已按 ${n} 岁更新今日推荐和周计划`)};return(0,k.jsxs)(`section`,{className:`page profile-page`,children:[(0,k.jsxs)(`div`,{className:`profile-title`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h1`,{children:`设置`}),(0,k.jsxs)(`p`,{children:[`你和 `,e.nickname,` 的温暖成长空间`]})]}),(0,k.jsx)(`img`,{src:A(`assets/mascot.webp`),alt:`芽芽陪伴你们`})]}),(0,k.jsxs)(`div`,{className:`profile-hero`,children:[(0,k.jsx)(Ge,{data:e,size:82}),(0,k.jsxs)(`div`,{children:[(0,k.jsxs)(`small`,{children:[e.age,` 岁的小小探索家`]}),(0,k.jsx)(`h2`,{children:e.nickname}),(0,k.jsxs)(`p`,{children:[`每天约 `,e.dailyMinutes,` 分钟 · 家中常见材料`]})]})]}),(0,k.jsxs)(`section`,{className:`profile-section`,children:[(0,k.jsxs)(`div`,{className:`section-heading`,children:[(0,k.jsx)(`div`,{children:(0,k.jsx)(`h2`,{children:`孩子档案`})}),(0,k.jsx)(`small`,{children:`年龄会影响活动推荐`})]}),(0,k.jsxs)(`div`,{className:`profile-fields`,children:[(0,k.jsxs)(`label`,{children:[(0,k.jsx)(`span`,{children:`小名`}),(0,k.jsx)(`input`,{value:e.nickname,maxLength:10,onChange:e=>a({nickname:e.target.value})})]}),(0,k.jsxs)(`label`,{children:[(0,k.jsx)(`span`,{children:`年龄`}),(0,k.jsx)(`select`,{value:e.age,onChange:e=>c(Number(e.target.value)),children:[2,3,4,5,6].map(e=>(0,k.jsxs)(`option`,{value:e,children:[e,` 岁`]},e))})]})]})]}),(0,k.jsxs)(`section`,{className:`profile-section avatar-section`,children:[(0,k.jsxs)(`div`,{className:`section-heading`,children:[(0,k.jsx)(`div`,{children:(0,k.jsx)(`h2`,{children:`选择孩子头像`})}),(0,k.jsx)(`small`,{children:`照片只保存在本机`})]}),(0,k.jsxs)(`div`,{className:`avatar-grid`,children:[Array.from({length:8},(t,n)=>(0,k.jsxs)(`button`,{"aria-label":`选择内置头像 ${n+1}`,className:e.avatarKind===`preset`&&e.avatarPreset===n?`selected`:``,onClick:()=>a({avatarKind:`preset`,avatarPreset:n}),children:[(0,k.jsx)(Ge,{data:{avatarKind:`preset`,avatarPreset:n,avatarData:``},size:62}),e.avatarKind===`preset`&&e.avatarPreset===n&&(0,k.jsx)(`i`,{children:(0,k.jsx)(j,{name:`check`,size:13})})]},n)),(0,k.jsxs)(`button`,{className:`upload-avatar`,onClick:()=>i.current?.click(),children:[(0,k.jsx)(j,{name:`camera`}),(0,k.jsx)(`span`,{children:`上传照片`})]})]}),(0,k.jsx)(`input`,{ref:i,hidden:!0,type:`file`,accept:`image/*`,onChange:e=>o(e.target.files?.[0])})]}),(0,k.jsxs)(`section`,{className:`settings-panel`,children:[(0,k.jsxs)(`div`,{className:`settings-title`,children:[(0,k.jsx)(j,{name:`settings`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h2`,{children:`家庭设置`}),(0,k.jsx)(`p`,{children:`让每天的安排更贴近你们的节奏`})]})]}),(0,k.jsxs)(`div`,{className:`setting-block`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:`每日亲子时长`}),(0,k.jsx)(`small`,{children:`会影响每天推荐的活动数量`})]}),(0,k.jsx)(`div`,{className:`segmented`,children:[20,30,45,60].map(t=>(0,k.jsxs)(`button`,{className:e.dailyMinutes===t?`active`:``,onClick:()=>a({dailyMinutes:t}),children:[t,` 分钟`]},t))})]}),(0,k.jsxs)(`div`,{className:`setting-block`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:`常用活动时段`}),(0,k.jsx)(`small`,{children:`可多选，不会发送系统通知`})]}),(0,k.jsx)(`div`,{className:`time-choices`,children:[`早餐后`,`上午`,`午睡后`,`傍晚`,`睡前`].map(t=>(0,k.jsx)(`button`,{className:e.activityTimes.includes(t)?`active`:``,onClick:()=>s(t),children:t},t))})]}),(0,k.jsxs)(`div`,{className:`setting-toggle`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(j,{name:`sparkle`}),(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`strong`,{children:`首页温和提示`}),(0,k.jsx)(`small`,{children:`开启后在首页显示一句陪伴提醒；关闭后隐藏，不会发送系统通知`})]})]}),(0,k.jsx)(`button`,{role:`switch`,"aria-label":`首页温和提示`,"aria-checked":e.reminders,className:e.reminders?`on`:``,onClick:()=>a({reminders:!e.reminders}),children:(0,k.jsx)(`i`,{})})]}),(0,k.jsxs)(`div`,{className:`setting-row`,children:[(0,k.jsxs)(`span`,{children:[(0,k.jsx)(j,{name:`leaf`}),`重点关注`]}),(0,k.jsx)(`strong`,{children:e.interests.join(` · `)})]})]}),(0,k.jsxs)(`section`,{className:`profile-section`,children:[(0,k.jsxs)(`div`,{className:`section-heading`,children:[(0,k.jsx)(`div`,{children:(0,k.jsx)(`h2`,{children:`安心使用`})}),(0,k.jsx)(`small`,{children:`留在当前设备`})]}),(0,k.jsx)(`p`,{className:`domain-note`,children:`孩子的小名、年龄、头像、计划与成长记录只保存在当前设备上。`})]}),(0,k.jsxs)(`section`,{className:`update-note`,children:[(0,k.jsx)(`span`,{children:`🌼`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`small`,{children:`小芽还在慢慢长大`}),(0,k.jsx)(`h2`,{children:`活动项目不断更新中`}),(0,k.jsx)(`p`,{children:`新的亲子游戏、生活课程和英语启蒙灵感，会陆续来到这里陪伴你们。`})]})]}),(0,k.jsxs)(`button`,{className:`favorites-settings-card`,onClick:n,children:[(0,k.jsx)(`span`,{className:`favorites-settings-icon`,children:(0,k.jsx)(j,{name:`heart`,size:23})}),(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`small`,{children:`收藏与灵感`}),(0,k.jsx)(`strong`,{children:`我的活动收藏夹`}),(0,k.jsx)(`em`,{children:e.favorites.length>0?`已经收藏 ${e.favorites.length} 个活动`:`喜欢的活动会安静地收在这里`})]}),(0,k.jsx)(`span`,{className:`favorites-settings-count`,children:e.favorites.length}),(0,k.jsx)(j,{name:`arrow`,size:18})]}),(0,k.jsxs)(`section`,{className:`home-screen-guide`,children:[(0,k.jsxs)(`div`,{className:`home-screen-title`,children:[(0,k.jsx)(`span`,{children:(0,k.jsx)(j,{name:`home`})}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h2`,{children:`保存到手机，随时打开`}),(0,k.jsx)(`p`,{children:`可以添加到桌面，也可以收藏到微信`})]})]}),(0,k.jsxs)(`details`,{children:[(0,k.jsxs)(`summary`,{children:[`iPhone / iPad 添加方法 `,(0,k.jsx)(j,{name:`arrow`,size:16})]}),(0,k.jsxs)(`ol`,{children:[(0,k.jsx)(`li`,{children:`先用 Safari 打开小芽计划`}),(0,k.jsx)(`li`,{children:`点击浏览器底部的“分享”按钮`}),(0,k.jsx)(`li`,{children:`选择“添加到主屏幕”，再点“添加”`})]})]}),(0,k.jsxs)(`details`,{children:[(0,k.jsxs)(`summary`,{children:[`安卓手机添加方法 `,(0,k.jsx)(j,{name:`arrow`,size:16})]}),(0,k.jsxs)(`ol`,{children:[(0,k.jsx)(`li`,{children:`用手机自带浏览器或平时常用的浏览器打开小芽计划`}),(0,k.jsx)(`li`,{children:`打开浏览器右上角或底部的菜单`}),(0,k.jsx)(`li`,{children:`选择“添加到桌面”“添加到主屏幕”“安装应用”或“创建快捷方式”`})]})]}),(0,k.jsxs)(`details`,{children:[(0,k.jsxs)(`summary`,{children:[`收藏到微信 `,(0,k.jsx)(j,{name:`arrow`,size:16})]}),(0,k.jsxs)(`ol`,{children:[(0,k.jsx)(`li`,{children:`在微信里打开小芽计划网址或扫码进入`}),(0,k.jsx)(`li`,{children:`点击页面右上角的“…”菜单`}),(0,k.jsx)(`li`,{children:`选择“收藏”，以后可在微信“我 → 收藏”中打开`})]})]}),(0,k.jsxs)(`div`,{className:`install-trouble`,children:[(0,k.jsx)(`strong`,{children:`找不到“添加到桌面”？`}),(0,k.jsx)(`p`,{children:`不同品牌手机的名称可能略有不同。如果当前在 GPT、微信等内置页面里，可先选择“在浏览器中打开”；也可以直接收藏到微信，之后从“我 → 收藏”进入。`})]})]}),(0,k.jsxs)(`footer`,{className:`copyright-footer`,children:[(0,k.jsx)(`span`,{className:`copyright-sprout`,children:`🌱`}),(0,k.jsx)(`strong`,{children:`小芽计划 Sprout Plan`}),(0,k.jsx)(`p`,{children:`© 2026 小芽计划。保留所有权利。`}),(0,k.jsx)(`p`,{children:`本产品的界面设计、文字内容、活动方案与原创插画仅供授权家庭个人使用。未经许可，请勿复制、转载、售卖或用于其他商业产品。`}),(0,k.jsxs)(`div`,{children:[(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`small`,{children:`X`}),`@hann7712`]}),(0,k.jsx)(`i`,{}),(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`small`,{children:`微信`}),`Canaan-77`]})]})]})]})}function st({text:e,label:t=`朗读`}){return(0,k.jsxs)(`button`,{className:`speech-button`,"aria-label":`${t}：${e}`,onClick:()=>Ze(e),children:[(0,k.jsx)(j,{name:`volume`,size:18}),(0,k.jsx)(`span`,{children:t})]})}function ct({activity:e}){let t=e.englishGuide;if(!t)return null;let n=[{label:`开场`,phrase:t.opening},{label:`游戏中`,phrase:t.during[0]||t.sentences[0]},{label:`结束`,phrase:t.ending}];return(0,k.jsxs)(`section`,{className:`english-parent-guide`,children:[(0,k.jsxs)(`header`,{children:[(0,k.jsx)(`span`,{children:`🌼`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h3`,{children:`家长怎么说`}),(0,k.jsx)(`p`,{children:`不用讲解语法，听一听、做一做、重复几次就够了。`})]})]}),(0,k.jsxs)(`h4`,{children:[`本次核心词 `,(0,k.jsx)(`small`,{children:`最多 3 个`})]}),(0,k.jsx)(`div`,{className:`core-words`,children:t.words.slice(0,3).map(e=>(0,k.jsxs)(`article`,{children:[(0,k.jsx)(`button`,{"aria-label":`朗读 ${e.word}`,onClick:()=>Ze(e.word),children:(0,k.jsx)(j,{name:`volume`,size:16})}),(0,k.jsx)(`strong`,{children:e.word}),(0,k.jsx)(`span`,{children:e.meaning})]},e.word))}),(0,k.jsxs)(`h4`,{children:[`核心句 `,(0,k.jsx)(`small`,{children:`最多 2 句`})]}),(0,k.jsx)(`div`,{className:`core-sentences`,children:t.sentences.slice(0,2).map(e=>(0,k.jsxs)(`div`,{children:[(0,k.jsxs)(`span`,{children:[(0,k.jsx)(`strong`,{children:e.english}),(0,k.jsx)(`small`,{children:e.chinese})]}),(0,k.jsx)(st,{text:e.english})]},e.english))}),(0,k.jsx)(`div`,{className:`parent-script`,children:n.map(e=>(0,k.jsxs)(`article`,{children:[(0,k.jsx)(`span`,{children:e.label}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`strong`,{children:e.phrase.english}),(0,k.jsx)(`small`,{children:e.phrase.chinese})]}),(0,k.jsx)(st,{text:e.phrase.english,label:`播放`})]},e.label))}),(0,k.jsxs)(`p`,{className:`speech-tip`,children:[(0,k.jsx)(j,{name:`volume`,size:16}),` 使用浏览器语音朗读，不需要付费接口；可以和孩子一起慢慢跟读。`]})]})}function lt({activity:e,favorite:t,onFavorite:n,onClose:r,onRecord:i}){return(0,k.jsx)(`div`,{className:`modal-backdrop`,onMouseDown:r,children:(0,k.jsxs)(`article`,{className:`sheet activity-sheet`,onMouseDown:e=>e.stopPropagation(),children:[(0,k.jsxs)(`div`,{className:`detail-art ${e.color}`,children:[(0,k.jsx)(Je,{activity:e}),(0,k.jsx)(`img`,{src:A(`assets/mascot.webp`),alt:`芽芽陪你开始活动`})]}),(0,k.jsxs)(`div`,{className:`detail-title`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsxs)(`small`,{children:[e.series,` · `,e.durationLabel,` · `,e.location]}),(0,k.jsx)(`h2`,{children:e.title}),(0,k.jsxs)(`div`,{className:`detail-age-row`,children:[(0,k.jsxs)(`span`,{children:[`适合 `,e.minAge,`–`,e.maxAge,` 岁`]}),(0,k.jsx)(`span`,{children:e.difficulty}),(0,k.jsx)(`span`,{children:e.adultSupport})]}),(0,k.jsx)(`p`,{children:e.goal})]}),(0,k.jsx)(`button`,{"aria-label":t?`取消收藏`:`收藏活动`,className:t?`active`:``,onClick:n,children:(0,k.jsx)(j,{name:`heart`})})]}),(0,k.jsxs)(`section`,{className:`material-box`,children:[(0,k.jsx)(`strong`,{children:`准备这些就够了`}),(0,k.jsx)(`p`,{children:e.materials.length?e.materials.join(` · `):`不需要额外材料`})]}),(0,k.jsx)(ct,{activity:e}),(0,k.jsxs)(`section`,{children:[(0,k.jsx)(`h3`,{children:`可以这样开始`}),(0,k.jsxs)(`blockquote`,{children:[`“`,e.opening,`”`]})]}),(0,k.jsxs)(`section`,{children:[(0,k.jsx)(`h3`,{children:`一起慢慢玩`}),(0,k.jsx)(`ol`,{children:e.steps.map((e,t)=>(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`span`,{children:t+1}),e]},e))})]}),(0,k.jsxs)(`section`,{children:[(0,k.jsx)(`h3`,{children:`聊一聊`}),e.questions.map(e=>(0,k.jsxs)(`p`,{className:`question`,children:[`“`,e,`”`]},e))]}),(0,k.jsxs)(`section`,{className:`easy-box`,children:[(0,k.jsx)(`strong`,{children:`今天想轻松一点`}),(0,k.jsx)(`p`,{children:e.easy})]}),(0,k.jsxs)(`section`,{className:`upgrade-box`,children:[(0,k.jsx)(`strong`,{children:`熟悉以后这样升级`}),(0,k.jsx)(`p`,{children:e.upgrade})]}),e.safety&&(0,k.jsxs)(`p`,{className:`safety`,children:[`安全提醒：`,e.safety]}),(0,k.jsx)(`button`,{className:`primary wide sticky-action`,onClick:i,children:`开始这个活动`})]})})}function ut({activity:e,onClose:t,onSave:n}){let[r,i]=(0,_.useState)(`玩得很开心`),[a,o]=(0,_.useState)(``);return(0,k.jsx)(`div`,{className:`modal-backdrop`,onMouseDown:t,children:(0,k.jsxs)(`article`,{className:`sheet record-sheet`,onMouseDown:e=>e.stopPropagation(),children:[(0,k.jsx)(`span`,{className:`record-sprout`,children:`🌱`}),(0,k.jsx)(`h2`,{children:`把这一刻种下来`}),(0,k.jsx)(`p`,{children:`不评分，只记下今天真实发生的事。`}),(0,k.jsx)(`h3`,{children:e.title}),(0,k.jsx)(`div`,{className:`reaction-grid`,children:[`玩得很开心`,`愿意参与`,`今天没兴趣`,`想再玩一次`].map(e=>(0,k.jsx)(`button`,{className:r===e?`active`:``,onClick:()=>i(e),children:e},e))}),(0,k.jsxs)(`label`,{className:`field`,children:[(0,k.jsx)(`span`,{children:`孩子今天说过的话（可选）`}),(0,k.jsx)(`textarea`,{value:a,onChange:e=>o(e.target.value),placeholder:`例如：这片叶子像一艘小船。`})]}),(0,k.jsx)(`button`,{className:`primary wide`,onClick:()=>n(e,r,a),children:`完成并种下一颗种子`})]})})}je(),v.createRoot(document.getElementById(`root`)).render((0,k.jsx)(_.StrictMode,{children:(0,k.jsx)(Ke,{})})),`serviceWorker`in navigator&&navigator.serviceWorker.register(`/sprout-plan-web/sw.js`);